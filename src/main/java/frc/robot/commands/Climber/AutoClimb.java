  ...
  public AutoClimb(Climber climber, Pivots pivots) {
    ...
    addCommands(
        ...
        new ClimbUp(climber, 55000, 55000, Constants.Climber.UP.s).withTimeout(2)
            ...
            .andThen(new PivotRelative(pivots, -10, Constants.Pivot.FAST_PID.s).withTimeout(1)),
        ...
        new PivotRelative(pivots, -30, Constants.Pivot.MODERATE_PID.s).withTimeout(1.5),
