...
public class AutoClimb extends SequentialCommandGroup {
  ...
  public AutoClimb(Climber climber, Pivots pivots) {
    ...
    addCommands(
      ...
      new PivotRelative(pivots, 90, 1).withTimeout(1.5).alongWith(new ClimbUp(climber, 2).withTimeout(1.5)),
      new PivotRelative(pivots, 10, 0).withTimeout(1),
      new PivotRelative(pivots, -30, 0).withTimeout(1.5),
